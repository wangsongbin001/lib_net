...
import com.wang.lib.net.builder.GetBuilder;
import com.wang.lib.net.builder.GlobalParams;
import com.wang.lib.net.builder.HeadBuilder;
import com.wang.lib.net.builder.OtherRequestBuilder;
import com.wang.lib.net.builder.PostFileBuilder;
import com.wang.lib.net.builder.PostFormBuilder;
import com.wang.lib.net.builder.PostStringBuilder;
import com.wang.lib.net.callback.Callback;
import com.wang.lib.net.https.HttpsUtils;
import com.wang.lib.net.intercepter.HttpLoggingInterceptor;
import com.wang.lib.net.intercepter.NetInterceptor;
import com.wang.lib.net.request.RequestCall;
import com.wang.lib.net.utils.Platform;
