...
import com.wang.lib.net.utils.Utils;
...
//    private static String fileSuffix = "";
    ...
    private String verifyFileName(String destFileDir, @Nullable String name, Response response) {
    ...
    private String getRealFileName(String name, ResponseBody body) {
        if (!name.contains(".")) {
    ...
    private String getFileRealSuffix(ResponseBody body) {
        String fileSuffix = "";
    ...
    private String createFileName( Response response) {
        ResponseBody body = response.body();
        String name;
        try {
    ...
    private String getRandomFileName( ResponseBody responseBody) {
